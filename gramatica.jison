...
LISTA_ARRAY : '[' ES ']' {$$ = [$1]}
;
LISTA_LISTAS_ARRAY : LISTA_LISTAS_ARRAY ',' LISTA_ARRAY {$1.push($3); $$=$1;}
                    |  LISTA_ARRAY {$$ = [$1]}
                    ;

DECLARACION_ARRAY : TIPODATO_DECLARACION IDS '[' E ']' '=' 'pr_new' TIPODATO_DECLARACION '[' E ']' ';' {}
                  | TIPODATO_DECLARACION IDS '[' ']' '='  LISTA_ARRAY ';' {}
                  |   TIPODATO_DECLARACION IDS '[' E ']''[' E ']' '=' 'pr_new' TIPODATO_DECLARACION '[' E ']''[' E ']' ';' {}
                  | TIPODATO_DECLARACION IDS '['  ']''['  ']' '=' LISTA_LISTAS_ARRAY  ';' {}
;
